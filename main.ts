...
namespace eureka_blocks {
  ...
  //% color="#858585" weight=24 blockId=eureka_m_driver block="ﾓｰﾀｰﾄﾞﾗｲﾊﾞｰD 動き|%mode| |%pin|" group="3_ユーレカ装置"
...
//% color="#d4b410"  weight=23 block="右ﾌｫﾄﾘｸﾚｸﾀｰ値 |%limit_R| より小さい" group="3　センサー"
...
//% color="#d4b410"  weight=24 block="右が黒線をふんだ" group="3　センサー" group="3　センサー"
...
//% color="#d4b41f"  weight=25 block="左ﾌｫﾄﾘｸﾚｸﾀｰ値 |%limit_L| より小さい" group="3　センサー"
